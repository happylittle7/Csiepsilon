var teamCard = [
    {
        ...
        title: "玩偶機構設計",
        serial: "A1",
        time: ["1:30", "1:50", "2:10", "2:30", "3:20", "3:35"],
        tag: "3D建模, 人偶製作",
        ...
        member: [
            {
                name: "塗嘉云",
                introduction: `科技組的身高天花板，負責製作玩偶專題。我從有記憶開始就對手作很有興趣，因此也毫不猶豫的加入了資電班。希望我們這次的成發能成為各位有趣的回憶(๑´ㅂ\`๑)`,
        ...
        title: "利用深度學習分析音樂相似度",
        serial: "A2",
        time: ["1:35", "1:55", "2:15", "2:35", "3:25", "3:40"],
        tag: "音樂相似度, 深度學習, 神經網路",
        ...
        member: [
            {
                name: "王子潔",
                introduction: "冷露歐蕾加白玉",
                img_url: "media/avatar/01.jpeg"
            },
            {
                name: "郎翊辰",
                introduction: `Hello~ 我是郎翊辰<br>
                因緣際會考進資電班，甚至到現在還是不知道我為什麼在這裡，從剛進來完全沒學習過寫程式，一步一步從C++學起，到後來遇到瓶頸暫時放棄，結果現在遇到更大的瓶頸，所以，我又重拾對程式的熱情了。學測fighting`,
                img_url: "media/avatar/21.jpg"
            },
            {
                name: "黃政翰",
                introduction: "高中才接觸程式設計，誤打誤撞走入了這個奇幻世界。一開始還很迷糊，甚至認為自己不適合這條路，不過再往更深處走才發現這個領域的有趣之處。",
        ...
        member: [
            {
                name: "伊東和毅",
                introduction: `
                我原本入學時就報名了資電班入試，不知道為甚麼面試就被刷下去了，高二報名轉入考終於成功轉進。<br>
                高一上了Ｃ++的課後開始<span class='delete'>認真</span>學習程式，學了<span class='bold'>HTML等程式語言</span><br>
                題外話，這網頁也是我寫的呦，`,
        ...
        member: [
            {
                name: "吳振宇",
                introduction: "早安🤟🏿我是大同凡凡，住在遙遠的新店安坑的⛰上，新店地靈人傑，滋養了我表演的天份，演戲和rap通通不在話下。雖然我是科技組的，但是資訊能力也是讚讚的，可謂是人才啊！期待在這條路上繼續精進⋯⋯💋想找到我就來高偉數學!!!",
            ...
            {
                name: "張詠翔",
                introduction: `嗨！大家我來自淡水downtown 郵遞區號25031的峰峰，從小就混跡在淡水河🌊一帶的我，因為看不慣淡水街頭逞兇鬥狠🩸的街頭文化，因此在高一分班時就選擇加入了資電專班，學習各式機械⚙️運作，另外我也非常喜歡唱歌喔🎤，下課除了與同學約裝水💧，我最愛的就是與朋友一起去k12唱歌了，因此還獲得了「大同吳青峰」的美名讚讚😚🤟👍🏿<br>
                下面這是我的抖音帳號 大家一定要來看喔😍`,
